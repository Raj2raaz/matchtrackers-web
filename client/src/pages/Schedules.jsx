    ...
    <div className="mx-auto">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-3 mb-4">
            <div className="flex items-center mb-3">
              ...
              <h2 className="text-gray-800 dark:text-gray-200 font-medium">Filter Matches</h2>
            </div>

            <div className="flex flex-wrap gap-3 mb-2">
              <div className="flex-1 relative">
                <div
                  className="bg-gray-50 dark:bg-gray-700 rounded-md border dark:border-gray-600 flex items-center justify-between p-2 cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-600"
                ...
                {showTeamDropdown && (
                  <div className="absolute z-10 mt-1 w-full bg-white dark:bg-gray-800 rounded-md shadow-md border dark:border-gray-600 max-h-48 overflow-y-auto">
                    {teams.map((team) => (
                      <div
                        key={team.id}
                      ...
                      >
                        <Image
                          ...
                          className="h-6 w-6 rounded-full"
                        />
                        <span className="text-sm text-gray-800 dark:text-gray-200">{team?.teamName}</span>
                      </div>
                    ))}
                  </div>
                )}
                  ...
                  <div className="flex items-center gap-2">
                    {selectedVenue ? (
                      <>
                        ...
                        <span className="text-gray-800 dark:text-gray-200 text-sm truncate max-w-[120px]">
                          {selectedVenue.ground}
                        </span>
                      </>
                    ) : (
                      <span className="text-gray-500 dark:text-gray-400 text-sm">Venue</span>
                    )}
                  </div>
                  <ChevronDown size={14} className="text-gray-400 dark:text-gray-500" />
                </div>
              ...
              <button
                className="bg-gray-50 dark:bg-gray-700 rounded-md border dark:border-gray-600 px-3 py-2 text-xs font-medium text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-600 flex items-center gap-1"
          ...
          {loading && (
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-8 mb-6 text-center">
              ...
              <p className="text-gray-600 dark:text-gray-400 mt-4">Loading match details...</p>
            </div>
          )}
          ...
          {!loading && !error && Object.keys(sortedMatches).length > 0 && (
            <div>
                      ...
                      {sortedMatches[dateKey].map((match) => {
                        ...
                        return (
                          <div
                            ...
                            className="bg-white dark:bg-gray-800 rounded-lg shadow mb-4 overflow-hidden transition-transform hover:translate-y-[-2px] hover:shadow-lg"
                          >
                                ...
                                <div className="flex flex-col items-end justify-between">
                                  ...
                                  <div className="flex gap-2 mt-4">
                                    <button
                                      ...
                                      className="bg-blue-600 hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 text-white px-3 py-1.5 rounded text-sm font-medium transition-colors"
                                    >
                                      Match Details
                                    </button>
                                  </div>
              ...
              {matchesLength < Object.keys(sortedMatches).length ? (
                <button
                  className="text-blue-600 dark:text-blue-400 mx-auto w-full cursor-pointer text-sm font-medium mt-2 hover:text-blue-700 dark:hover:text-blue-300 transition-colors"
                  onClick={() => {
          ...
          {!loading && !error && Object.keys(sortedMatches).length === 0 && (
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-8 mb-6 text-center">
              ...
              <button
                className="mt-4 bg-blue-600 hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors"
                onClick={clearFilters}
              >
                Clear Filters
              </button>
        ...
        <div>
          ...
          <div className="bg-gradient-to-r from-blue-600 to-blue-800 dark:from-blue-700 dark:to-blue-900 text-white rounded-lg shadow p-4 mb-6">
            <div className="flex justify-between items-center mb-4">
              ...
              <Link
                ...
                className=" text-sm flex items-center gap-1 hover:underline opacity-90 hover:opacity-100 transition-opacity"
              >
                View Full Table
                <svg
                  className="w-4 h-4"
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full ">
                <thead className="">
                  <tr className="bg-gray-50 dark:bg-gray-800 text-left ">
                    <th className="p-2 text-xs font-medium text-gray-500 dark:text-gray-400">
                      #
                    </th>
                    <th className="p-2 text-xs font-medium text-gray-500 dark:text-gray-400">
                      Team
                    </th>
                    <th className="p-2 text-xs font-medium text-gray-500 dark:text-gray-400 text-right">
                      M
                    </th>
                    <th className="p-2 text-xs font-medium text-gray-500 dark:text-gray-400 text-right">
                      W
                  ...
                  {pointTable &&
                    pointTable.slice(0, 4).map((team, index) => (
                      ...
                      >
                        ...
                        <td className="p-2 text-sm text-right text-white">
                          {team.matchesPlayed}
                        </td>
                        <td className="p-2 text-sm text-right text-white">
                          {team.matchesWon}
              ...
              <div className="flex justify-center w-full text-white opacity-60">•••</div>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-4 mb-6">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-lg font-bold text-gray-800 dark:text-gray-200">Latest News</h2>
              <a
                href="/news"
