  ...
  return (
    <div className="flex flex-col overflow-hidden">
      ...
      <div className="bg-gradient-to-br from-[#002b5b] via-[#1e40af] to-[#002b5b] py-10 sm:py-12 px-4 sm:px-6 relative overflow-hidden">
        ...
        {/* Animated background */}
        <div className="absolute inset-0 bg-[#002B5B] opacity-10 z-0">
            ...
            {seriesList && seriesList.length > 0 ? (
              seriesList.slice(0, seriesShown).map((e, i) => (
                <div
                  ...
                  key={i}
                  className="bg-gray-100 hover:bg-gray-200 cursor-pointer w-full px-4 py-3 rounded-lg shadow-sm border border-gray-300 transition duration-200"
                >
                  <p className="text-base text-gray-800 font-semibold leading-snug break-words">
                    {e.name}
                  </p>
                </div>
              ))
