        ...
        {upcomingMatches?.length > 0 &&
          upcomingMatches?.slice(0, 4).map((match, i) => (
            <div
              ...
              className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg hover:shadow-md transition-all duration-200 cursor-pointer p-4"
              key={i}
            >
              {/* Match Header */}
              ...
              <div className="flex items-center justify-between mb-3">
                ...
                {/* VS */}
                <div className="text-gray-400 dark:text-gray-500 text-sm font-medium mx-4">
                  vs
                </div>
